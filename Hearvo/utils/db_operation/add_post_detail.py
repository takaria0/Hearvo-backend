...
for post in posts:
	new_vote_selects = VoteSelect.query.filter_by(post_id=post.id).all()
	new_user_info_post_voted = UserInfoPostVoted.query.filter_by(post_id=post.id).all()
	new_vote_select_user = VoteSelectUser.query.filter_by(post_id=post.id).all()
  ...
  for user_info_post_voted in new_user_info_post_voted:
    user_info_post_voted.post_detail = new_post_detail_id
  ...
  for vote_select_user in new_vote_select_user:
    vote_select_user.post_detail = new_post_detail_id
